...
use App\Http\Controllers\API\Device\AccomodationController;
use App\Http\Controllers\API\Device\AccomodationFacitityController;
use App\Http\Controllers\API\Device\AccomodationTypeController;
use App\Http\Controllers\API\Device\AccreditationController;
use App\Http\Controllers\API\Device\AccreditationHospitalController;
use App\Http\Controllers\API\Device\ActiveQueryController;
use App\Http\Controllers\API\Device\AuthController;
use App\Http\Controllers\API\Device\ConfirmedQueryController;
use App\Http\Controllers\API\Device\DesignationController;
use App\Http\Controllers\API\Device\DetoxificationCategoryController;
use App\Http\Controllers\API\Device\DetoxificationWellnessController;
use App\Http\Controllers\API\Device\DoctorController;
use App\Http\Controllers\API\Device\DoctorHospitalController;
use App\Http\Controllers\API\Device\DoctorPatientTestimonialController;
use App\Http\Controllers\API\Device\DoctorSpecializationController;
use App\Http\Controllers\API\Device\DoctorTagController;
use App\Http\Controllers\API\Device\DoctorTreatmentController;
use App\Http\Controllers\API\Device\FacilityController;
use App\Http\Controllers\API\Device\FileUploadController;
use App\Http\Controllers\API\Device\HospitalController;
use App\Http\Controllers\API\Device\HospitalTagsController;
use App\Http\Controllers\API\Device\HospitalTreatmentController;
use App\Http\Controllers\API\Device\PastQueryController;
use App\Http\Controllers\API\Device\PatientDetailsController;
use App\Http\Controllers\API\Device\PatientFamilyController;
use App\Http\Controllers\API\Device\PatientFamilyDetailsController;
use App\Http\Controllers\API\Device\PatientTestimonyController;
use App\Http\Controllers\API\Device\PatientTestimonyTagController;
...
use App\Http\Controllers\API\Device\TestController;
use App\Http\Controllers\API\Device\TreatmentController;
