...
class BulkUpdateQueryAPIRequest extends FormRequest
{
    /**
     * @return bool
     */
    ...
    public function rules(): array
    {
        return [
            ...
            'data.*.name' => ['string', 'required', 'unique:queries,name,'.$this->route('query')],
            ...
            'data.*.status' => ['string', 'required', 'unique:queries,status,'.$this->route('query')],
